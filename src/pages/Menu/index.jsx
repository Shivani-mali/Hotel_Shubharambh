...
const promotionalOffers = [
  ...
  { id: 2, title: 'हॉटेल शुभारंभ खासियत', img: flayer1, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false },
  { id: 3, title: 'हॉटेल शुभारंभ खासियत', img: flayer2, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false },
  { id: 4, title: 'हॉटेल शुभारंभ खासियत', img: flayer3, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false },
  { id: 5, title: 'हॉटेल शुभारंभ खासियत', img: flayer4, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false },
  { id: 6, title: 'हॉटेल शुभारंभ खासियत', img: flayer5, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false },
  { id: 7, title: 'हॉटेल शुभारंभ खासियत', img: flayer6, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false },
  { id: 8, title: 'हॉटेल शुभारंभ खासियत', img: flayer7, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false },
  { id: 9, title: 'हॉटेल शुभारंभ खासियत', img: flayer8, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false },
  { id: 10, title: 'हॉटेल शुभारंभ खासियत', img: flayer9, badge: '✨ आमची खासियत', desc: 'कोल्हापुरी अस्सल चव', isOffer: false }
];
...
const Menu = () => {
  ...
  return (
    <div className="bg-[#FAF8F5] min-h-screen font-sans selection:bg-[#D4AF37] selection:text-[#111]">
      <SEO title="आमचे मेनू | शुभारंभ (Fine Dining Menu)" description="अस्सल कोल्हापुरी चव आणि लक्झरी अनुभव. आमचे प्रीमियम डिजिटल मेनू पहा." />
